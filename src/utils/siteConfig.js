module.exports = {
    ...
    siteTitleMeta: `La web de Guillermo Gascón SEO`, // This allows an alternative site title for meta data for pages.
    ...
    shortTitle: `Guillermo G`, // Used for App manifest e.g. Mobile Home Screen
